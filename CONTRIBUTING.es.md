...
- **Un juego nuevo** → `app/games/<juego>/`, registrado con `@register` y
  ...
  [`docs/es/juego-nuevo.md`](docs/es/juego-nuevo.md), y cada juego lleva su
  documento en `docs/`.
...
La documentación es bilingüe: inglés en `docs/`, español en `docs/es/`. Un
cambio que toque una tiene que tocar la otra — una traducción desactualizada
